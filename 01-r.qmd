...
[![](images/covid-tracker-dashboard.png)](https://vac-lshtm.shinyapps.io/ncov_tracker/)


## Reproducibilidad

[![](images/covid-tracker-github.png)](https://github.com/eparker12/nCoV_tracker)

## Instalación de R (Windows) {.smaller}

Para instalar R (Febrero de 2026):
...
4. Dar click en [Download R-4.5.2 for Windows](https://cran.r-project.org/bin/windows/base/R-4.5.2-win.exe).
5. Luego de que se haya finalizado la descarga, ejecutar el archivo __R-4.5.2-win.exe__. En caso Windows preguntara si deseamos que la aplicación haga cambios en el sistema, respondemos que __Sí__.
...
Para instalar RStudio Desktop (Febrero de 2026):

1. Asegurarse de tener instalado R.
2. Ir a la web <https://posit.co/download/rstudio-desktop/> o buscar en el navegador web "rstudio download".
3. Dar click en [DOWNLOAD RSTUDIO FOR WINDOWS](https://download1.rstudio.org/electron/windows/RStudio-2026.01.0-392.exe). Se descargará el instalador con nombre __RStudio-2026.01.0-392.exe__.
